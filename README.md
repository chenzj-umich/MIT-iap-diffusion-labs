![banner](banner.png)
# Welcome!
This repository contains the labs for [*6.S184/6.S975: Generative AI with Stochastic Differential Equations*](https://diffusion.csail.mit.edu), as taught at MIT over IAP 2026. For questions and concerns, please email us at `ezraerives@gmail.com`, `phold@mit.edu`, and `ronsh@mit.edu`. Enjoy :)
...
- 1/11/26: Lab 2: Fix "doubly stochastic" diffusion coefficient bug in `ConditionalVectorFieldSDE` and `LangevinFlowSDE` (thanks Mariia!)
